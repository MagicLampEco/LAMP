...
/** Tổng quỹ SRCL tính bằng oil = 3,6e8 × 1e6 = 3,6e14 oil. */
...
/** Ngân sách LAMP MỖI epoch (oil), chia đều: 3,6e14 / 36 = 10_000_000_000_000 oil
 *  = 10.000.000 LAMP chẵn. 360M chia hết 36 nên KHÔNG có dư lẻ. */
export const PER_EPOCH_OIL = SRCL_TOTAL_OIL / EPOCHS;

/** Dư lẻ do chia floor = 3,6e14 − 36 × PER_EPOCH_OIL (oil) = 0 (360M ⋮ 36). */
