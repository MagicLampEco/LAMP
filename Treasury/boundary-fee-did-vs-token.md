...
**không giữ** `DESIGN-fee-paymaster-reserve.md`. `Specs/` sau đó bị PR #19 tách thành `Papers/`
(đối ngoại) + spec nội bộ trong thư mục module, nên bản Paymaster nay là
[`paymaster-design.md`](./paymaster-design.md) — vẫn còn trỏ `DESIGN §A` ở `:158,559-560`, một dẫn
chiếu treo cần dọn riêng, không thuộc phạm vi file này.
