// ISPO entitlement — tính đúng tỷ lệ stake + bảo toàn tổng quỹ epoch.
...
import {
  PER_EPOCH_OIL, REMAINDER_OIL, ISPO_TOTAL_OIL, EPOCHS, END_EPOCH,
} from "../src/constants.js";
import type { StakeEntry } from "../src/types.js";
import { verifyProof } from "../src/merkle.js";

describe("hằng quỹ ISPO", () => {
  it("tổng = 1 tỷ LAMP = 1e15 oil", () => {
    expect(ISPO_TOTAL_OIL).toBe(1_000_000_000_000_000n);
  });
  it("36 epoch", () => {
  ...
  it("36 × PER_EPOCH + REMAINDER = tổng (không mất oil)", () => {
    expect(PER_EPOCH_OIL * EPOCHS + REMAINDER_OIL).toBe(ISPO_TOTAL_OIL);
  });
