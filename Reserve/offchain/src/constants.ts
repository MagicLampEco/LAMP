...
/** Cap Reserve = 9,630 tỷ LAMP × 10^6 = 9_630_000_000_000_000 oil (allocation v17).
 *  Chia chẵn cho RELEASE_EPOCHS → trần epoch là số nguyên (dư 0). */
export const RESERVE_TOTAL_OIL = 9_630_000_000_000_000n;

/** Trần CỨNG nhả mỗi epoch = RESERVE_TOTAL_OIL / 1000 = 9_630_000_000_000 oil. */
