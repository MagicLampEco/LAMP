...
- ~~`capOildrop` cho pot Delegator~~ — **KHÔNG còn là điểm mở**: đã chốt ràng buộc luôn `null`
  (§1.6). Chỉ được đưa lại vào danh sách này khi hệ ép được **một-người-một-DID** on-chain.
