# ETD — Early TIGER Delegation pot (12.000 nghìn LAMP = 12 triệu = 0,03% của 36 tỷ)
...
Distribution/ETD/tests/   # entitlement.test.ts + dripB.test.ts  (34 test)
```
...
```bash
cd Distribution/ETD/offchain && npm install && npm test     # 34/34 pass
```
