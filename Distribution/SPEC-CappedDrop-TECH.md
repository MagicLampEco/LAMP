...
pub type ClaimAccountDatum {
  ...
  entitlement     : Int,         // E — tổng LAMP (oil)
...
Constr(0, [
  ...
  Integer(entitlement),      -- field 1: E (oil, non-negative)
  Integer(redeemed),         -- field 2: đã rút tích lũy (oil)
...
Constr(0, [
  ...
  Integer(drop_value),       -- field 2: D (oil/drop)
])
```
...
| `INITIAL_DROP_VALUE` | `D₀` (oil/drop) — tham số kinh tế | Datum Beacon genesis |
