...
//
//   Hệ quả thực dụng: `canonical_mint.ts` (đã xoá khỏi kho — tra
//   `git show 930480e:Genesis/scripts/canonical_mint.ts`) từng phải đòi `BEACON_NFT_POLICY`
//   từ ngoài vì nó
